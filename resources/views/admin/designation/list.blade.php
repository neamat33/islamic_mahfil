    ...
    <div class="container-fluid">
                            ...
                            @foreach ($designations as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- <a href="{{ url('delete-Designation/' . $item->id) }}"
        ...
        <div class="modal fade  mb-5" id="EditModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="update-Designation-form" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="form-group">
        ...
        <script>
            $(function(){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ url('admin/designation_edit') }}",
                    data: {
                        id: id
                    },
                    success: function(data) {
                        ...
                        var formActionUrl = "{{ url('admin/designations/update') }}/" + id;
                        $('#update-Designation-form').attr('action', formActionUrl);
                    },
                });
            });
            })

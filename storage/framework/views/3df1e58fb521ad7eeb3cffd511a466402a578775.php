                    ...
                    <div class="alert-success alert mb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                                <div class="h6 mb-0">Income</div>
                                <span class="small">Tk <?php echo e($income[0]->total); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="alert-danger alert mb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-fill ms-3 text-truncate">
                                ...
                                <span class="small">TK <?php echo e($expense[0]->total); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP8.2\islamicmahfil\resources\views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>